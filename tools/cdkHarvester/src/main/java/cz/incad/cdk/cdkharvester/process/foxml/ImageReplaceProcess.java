...
public class ImageReplaceProcess implements ProcessFOXML {
    ...
    public static final String[] REDIRECTED_DATASTREAM = { 
    ...
    public byte[] process(String name, final String url, final String pid, InputStream is) throws Exception {
        ...
        if (docElement.getLocalName().equals("digitalObject")) {
            ...
            for (final Element datStreamElm : binaryDatastreams) {
                ...
                List<Element> versions = XMLUtils.getElements(datStreamElm,
                ...
                for (Element version : versions) {
                    Element found = XMLUtils.findElement(version, "contentLocation",
