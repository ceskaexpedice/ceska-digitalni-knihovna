...
public class CheckTransformationAccessible implements IterationControl {

	public static final Logger LOGGER = Logger.getLogger(ChecksEnum.transformable.name());
